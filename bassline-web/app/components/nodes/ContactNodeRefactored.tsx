...
export const ContactNodeRefactored = memo(({ id, selected }: NodeProps) => {
  ...
  return (
    <FlowNode
      ...
      interactive={{
        ...
        // Selection behaviors - clean and simple!
        selection: {
...
ContactNodeRefactored.displayName = 'ContactNodeRefactored';