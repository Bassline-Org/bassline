...
export class Pool<Tags = any> extends EventTarget implements IPool {
...
export interface IAssertion<T = any, K extends AssertionKind = AssertionKind> extends Record<string, any> {
    id: string,
    kind: K,
    tag: T,
