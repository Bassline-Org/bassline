...
export const WildcardNode = memo(({ id, data }) => {
    return (
        <div
            className="relative bg-gradient-to-br from-orange-400 to-orange-600 text-white rounded-lg flex items-center justify-center font-bold text-5xl shadow-lg hover:from-orange-500 hover:to-orange-700 transition-all transform rotate-45"
            style={{
                width: '100%',
                height: '100%',
