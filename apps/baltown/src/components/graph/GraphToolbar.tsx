    ...
    <>
      <div class="graph-toolbar">
        <div class="toolbar-group">
          <button class="toolbar-btn" onClick={() => setShowAddCellModal(true)} title="Add Cell">
            <svg
              width="16"
              height="16"
              viewBox="0 0 24 24"
        ...
        <div class="toolbar-group">
          <button class="toolbar-btn" onClick={() => props.onAutoLayout?.()} title="Auto Layout">
            <svg
              width="16"
              height="16"
              viewBox="0 0 24 24"
          ...
          <button class="toolbar-btn" onClick={() => props.onFitView?.()} title="Fit View">
            <svg
              width="16"
              height="16"
              viewBox="0 0 24 24"
        ...
        <div class="toolbar-group zoom-controls">
          <button class="toolbar-btn" onClick={() => props.onZoomOut?.()} title="Zoom Out">
            <svg
              width="16"
              height="16"
              viewBox="0 0 24 24"
          ...
          <button class="toolbar-btn" onClick={() => props.onZoomIn?.()} title="Zoom In">
            <svg
              width="16"
              height="16"
              viewBox="0 0 24 24"
        ...
        <div class="toolbar-group">
          ...
          <button class="toolbar-btn" onClick={() => props.onExport?.()} title="Export">
            <svg
              width="16"
              height="16"
              viewBox="0 0 24 24"
