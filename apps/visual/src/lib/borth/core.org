...
Different parsing words will modify compilation units differently. Parsing words such as =;= are delimiters, which just means they invoke the =delimiter= word, which when evaluated, simply says finish the top compilation unit.
