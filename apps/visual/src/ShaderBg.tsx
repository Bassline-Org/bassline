 ...
 */
export function SmokeyBackground({ backdropBlurAmount = 'sm', className = '' }: SmokeyBackgroundProps): JSX.Element {
  ...
  useEffect(() => {
    ...
    const color = theme === 'light' ? '#e9ecef' : '#14213d'
    ...
    return () => {}
  }, [theme]) // Add color to the dependency array
