...
export default async function seedVals(bl) {
  ...
  await bl.put('bl:///vals/examples/double', {}, {
  ...
  await bl.put('bl:///vals/examples/celsius-to-fahrenheit', {}, {
  ...
  await bl.put('bl:///vals/examples/counter-cell', {}, {
  ...
  await bl.put('bl:///vals/examples/counter-widget', {}, {
  ...
  await bl.put('bl:///vals/examples/sum-cells', {}, {
  ...
  await bl.put('bl:///vals/examples/format-currency', {}, {
  ...
  await bl.put('bl:///vals/examples/status-checker', {}, {
